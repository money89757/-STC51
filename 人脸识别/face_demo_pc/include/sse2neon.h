...
FORCE_INLINE __m128 _mm_shuffle_ps_2020(__m128 a, __m128 b)
{
...
FORCE_INLINE __m128 _mm_shuffle_ps_function(__m128 a, __m128 b)
{
	switch (i)
	{
		...
		case _MM_SHUFFLE(2, 0, 2, 0): return _mm_shuffle_ps_2020(a, b); break;
...
// Compute the approximate reciprocal square root of packed single-precision (32-bit) floating-point elements
FORCE_INLINE __m128 _mm_rsqrt_ps(__m128 x)
{
